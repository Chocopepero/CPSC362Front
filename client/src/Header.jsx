        ...
        <div>
            <header className="p-4 flex justify-between items-center bg-blue-500 text-white">
                <Link to="/" className="flex items-center gap-1 
                                    ">
                    <img src={HotelLogo} alt="Hotel Blissful Logo" className="
                                    max-w-[100px] max-h-[100px] bg-transparent "/>
                ...
                <div className="container m-auto">
                    <div className="flex text-lg justify-center gap-40 ">
                        <Link to="/amenities" className="flex box-border items-center gap-10
                         bg-blue-500 hover:scale-110 hover:bg-sky-700 active:border-white">
                            <FontAwesomeIcon icon={faBellConcierge} />
                            <p>Amenities</p>
                        </Link>
                        <Link to="/services" className="flex box-border items-center gap-10
                         bg-blue-500 hover:scale-110 hover:bg-sky-700 active:border-white">
                            <FontAwesomeIcon icon={faCircleInfo} />
                            <span>Services & Info</span>
                        </Link>
                        <Link to="/reservations" className="flex box-border items-center gap-10
                         bg-blue-500 hover:scale-110 hover:bg-sky-700 active:border-white">
